...
vim.api.nvim_create_autocmd('VimResized', {
	callback = function() columns = vim.api.nvim_get_option 'columns' end,
	group = 'config',
})
...
require('heirline').setup({statusline =
{
	...
	{
		hl = {bg = MIDBAR, fg = ICE},
		provider = function() return lsp_progress.progress {max_size = math.floor(columns / 3)} end,
		update = {'User', callback = redrawstatus, pattern = 'LspProgressStatusUpdated'},
	},
	-- }}}
